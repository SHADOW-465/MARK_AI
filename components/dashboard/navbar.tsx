...
export const Navbar = ({ isTeacher, userName, userEmail, userInitials }: NavbarProps) => {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 h-20 z-50 px-6 flex items-center justify-between bg-background/50 backdrop-blur-xl border-b border-border/40 transition-all duration-300">
